...
class datatumbuhan {
    ...
    public void sorting() {
        ...
        for (batas = nElemen - 1; batas > 0; batas--) {
            for (i = 0; i < batas; i++) {
                if (tumbuh[i].getNamaTumbuhan().compareTo(tumbuh[i + 1].getNamaTumbuhan()) > 0) {
                    swap(i, i + 1);
                    swapping++;
                }
            }
    ...
    public void Bubblesortangka() {

        int batas, i;
        for (batas = nElemen - 1; batas > 0; batas--) {
            for (i = 0; i < batas; i++) {
                if (tumbuh[i].urut()>tumbuh[i+1].urut()) {
                    swap(i, i + 1);
                    swapping++;
                }
            }
...
//                            tumbuh[i].displaytumbuhan();
//                        }
//                        System.out.println("apakah ingin menampilkan daftar tumbuhan secara urut dengan abjad(y/n)");
//                        String ulang3 = readString();
//                        if (ulang3.equals("y") || ulang3.equals("Y")) {
//                            urutin();
//                            tampilkan();
//                        } else {
//                            tampilkan();
//                        }
                    ...
                    if (data == 3) {
                        sorting();
                        tampilkan();
                        System.out.println("\nTotal Perpindahan: "+Totalswapping());
                        System.out.println("Total literasi: "+Totalliterasi());
