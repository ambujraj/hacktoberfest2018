...
public class Project_UAS2 {
    ...
    public  void Bubblesort(String []data) {
        String[] datatumbuhan=data;
        String temp;
//        System.out.println("tanaman belum diurutkan di urutkan");
       
        System.out.println("=====================================");
        
//        System.out.println("tanaman sudah diurutkan");
////        for (int i = 0; i < datatumbuhan.length; i++) {
////            System.out.println(i+1+""+datatumbuhan[i]+"");
////        }
        for (int i = 0; i < datatumbuhan.length-1; i++) {
            for (int j = 0; j < datatumbuhan.length-1; j++) {
                if (datatumbuhan[j].compareTo(datatumbuhan[j+i])>0) {
                    temp=datatumbuhan[j+1];
                    datatumbuhan[j+1]=datatumbuhan[j];
                    datatumbuhan[j]=temp;
                }
            }
        }
...
//                        System.out.println("25.Akar wangi");
            ...
            System.out.println("Copyright Lexy sekeluarga");
        } catch (Exception e) {
